...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!array_filter($errors)) {
        $stmt = $conn->prepare("INSERT INTO campaign (id_bisnis, judul, deskripsi, tanggal_mulai, tanggal_selesai, target_dana, dana_terkumpul, jumlah_view_unit, dana_per_view, status, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'draft', NOW())");
...
<body>
  <div class="form-container">
    <form method="POST" enctype="multipart/form-data">
      ...
      <input type="file" name="foto_kampanye" accept="image/*">
      <div class="field-error"><?= $errors['foto_kampanye'] ?></div>
