    ...
    <div class="container">
        ...
        <div class="form-box register" id="register">
            <form action="register.php" method="POST">
                ...
                <button type="submit" class="btn"><a href="php/form.php"></a>Register</button>
                <div class="user">
                    <p>WHO ARE YOU</p>
                    <label>
                        <input type="radio" name="user" value="business" required>
                        <span>BISNIS</span>
                    </label>
    
                    <label >
                        <input type="radio" name="user" value="influencer" required>
