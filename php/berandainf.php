        ...
        <div class="sidebar">
            ...
            <div class="profile d-flex align-items-center">
                <div class="bg-info text-white rounded-circle d-flex align-items-center justify-content-center" style="width: 40px; height: 40px;">
                    <?php echo strtoupper(substr($_SESSION['user_data']['username'], 0, 2)); ?>
                </div>
                <div class="ms-2">
                    <strong><?php echo htmlspecialchars($_SESSION['user_data']['username']); ?></strong>
                    <div style="font-size: 0.8rem; color: var(--text-light);">
                        <?php echo ucfirst($_SESSION['user_data']['user_type']); ?>
                    </div>
                </div>
            </div>
        </div>
