...
CREATE TABLE escrow (
  ...
  KEY id_bisnis (id_bisnis),
  CONSTRAINT escrow_ibfk_1 FOREIGN KEY (id_campaign) REFERENCES campaign(id) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT escrow_ibfk_2 FOREIGN KEY (id_bisnis) REFERENCES USER_BISNIS(id) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
